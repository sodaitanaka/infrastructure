...
> ※ 要件定義+設計：小案件=16h、中案件=24h、大案件=40h
> ※ ー = 該当作業なし（工数0）

| 作業項目 | A | B | C | D | E | F |
|---|:---:|:---:|:---:|:---:|:---:|:---:|
| **〈上流〉** | 小案件 | 中案件 | 小案件 | 大案件 | 小案件 | 中案件 |
| 要件定義 | 1 | 1.5 | 1 | 3 | 1 | 1.5 |
| 設計（基本設計・詳細設計） | 1 | 1.5 | 1 | 2 | 1 | 1.5 |
| **〈開発〉** | | | | | | |
| データソース層<br><small>外部API連携・差分更新・スケジューリング</small> | 0.5 | 2.5 | 1 | 6 | 0.5 | 0.5 |
| データ層<br><small>DB設計・実装・マルチテナント対応</small> | 0.5 | 0.5 | ー | 10 | 0.5 | 0.5 |
| バックエンド層<br><small>n8nフロー構築・Claude API連携・APIサーバー</small> | 3 | 4 | 2 | 18 | 3 | 4 |
| UI層<br><small>画面実装・フィルタ・承認フロー</small> | ー | ー | ー | 22 | ー | ー |
| DM送信連携<br><small>送信自動化・レート制限・安全設定</small> | ー | ー | 1 | 2 | ー | 3 |
| 外部SaaS設定・連携<br><small>BD / PB / AH アカウント設定・Webhook・インポート設定</small> | 0.5 | 1 | 2 | 3 | 1 | 1.5 |
| **〈検証〉** | | | | | | |
| 内部検証（単体・結合テスト） | 1.5 | 2 | 1.5 | 12 | 2 | 2 |
| UAT支援（クライアント確認・修正対応） | 1 | 1 | 1.5 | 8 | 1 | 1.5 |
| **〈その他〉** | | | | | | |
| リリース・デプロイ | 0.5 | 0.5 | 0.5 | 4 | 0.5 | 0.5 |
| PM・ドキュメント・バッファ | 0.5 | 0.5 | 1 | 10 | 2 | 0.5 |
| **合計（人日）** | **10** | **15** | **12.5** | **100** | **12.5** | **17.5** |
| **合計（時間）** | **80h** | **120h** | **100h** | **800h** | **100h** | **140h** |
