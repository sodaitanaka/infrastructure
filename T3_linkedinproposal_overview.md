...
| 設計（基本設計・詳細設計） | ◯ | ◯ | ◯ | ◯ | ◯ | ◯ |
| **〈開発〉** | | | | | | |
| データソース層<br><small>外部API連携・差分更新・スケジューリング</small> | ◯ | ◯ | ◯ | ◯ | ◯ | ◯ |
| データ層<br><small>DB設計・実装・マルチテナント対応</small> | ◯ | ◯ | ✗ | ◯ | ◯ | ◯ |
| バックエンド層<br><small>n8nフロー構築・Claude API連携・APIサーバー</small> | ◯ | ◯ | ◯ | ◯ | ◯ | ◯ |
| UI層<br><small>画面実装・フィルタ・承認フロー</small> | ✗ | ✗ | ✗ | ◯ | ✗ | ✗ |
| DM送信連携<br><small>送信自動化・レート制限・安全設定</small> | ✗ | ✗ | ◯ | ◯ | ✗ | ◯ |
| 外部SaaS設定・連携<br><small>BD / PB / AH アカウント設定・Webhook・インポート設定</small> | ◯ | ◯ | ◯ | ◯ | ◯ | ◯ |
| **〈検証〉** | | | | | | |
| 内部検証（単体・結合テスト） | ◯ | ◯ | ◯ | ◯ | ◯ | ◯ |
| UAT支援（クライアント確認・修正対応） | ◯ | ◯ | ◯ | ◯ | ◯ | ◯ |
| **〈その他〉** | | | | | | |
